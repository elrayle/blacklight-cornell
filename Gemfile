...
gem 'ld4l_virtual_collection', :github => 'ld4l/ld4l_virtual_collection', :branch => 'update_to_bc_08-2015'
gem 'ld4l-works_rdf', :github => 'ld4l/works_rdf', :branch => 'upgrade_at0.8'
gem 'ld4l-foaf_rdf', :github => 'ld4l/foaf_rdf', :branch => 'master'
gem 'ld4l-open_annotation_rdf', '~> 0.1'
gem 'doubly_linked_list', '~> 0.0'
gem 'ld4l-ore_rdf', :github => 'ld4l/ore_rdf', :branch => 'at-solr_integration'
