Feature: Results list
 ...
 @pub_info
  ...
  Scenario: Remove spaces from call number queries in Blacklight
    ...
    And I press 'search'
    Then I should get results
    And it should have a "title" that looks sort of like "Shore and sea boundaries : with special reference to the interpretation and use of Coast and Geodetic Survey data"
